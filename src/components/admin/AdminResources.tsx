...
export default function AdminResources() {
  ...
  const resetForm = () => { setForm({ title: "", description: "", url: "", resource_type: "video", topic_id: "" }); setEditId(null); };
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <p className="text-muted-foreground">{resources.length} resources total</p>
