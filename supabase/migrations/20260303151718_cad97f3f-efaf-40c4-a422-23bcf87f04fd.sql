...
CREATE POLICY "Admins can view all plans" ON public.study_plans FOR SELECT TO authenticated USING (has_role(auth.uid(), 'admin'::app_role));
...
CREATE POLICY "Admins can view all plan items" ON public.study_plan_items FOR SELECT TO authenticated USING (has_role(auth.uid(), 'admin'::app_role));
...
CREATE POLICY "Admins can manage resources" ON public.learning_resources FOR ALL TO authenticated USING (has_role(auth.uid(), 'admin'::app_role));
...
CREATE POLICY "Admins can view all answers" ON public.quiz_answers FOR SELECT TO authenticated USING (has_role(auth.uid(), 'admin'::app_role));
...
CREATE POLICY "Admins can view all recommendations" ON public.resource_recommendations FOR SELECT TO authenticated USING (has_role(auth.uid(), 'admin'::app_role));
CREATE POLICY "Admins can manage recommendations" ON public.resource_recommendations FOR ALL TO authenticated USING (has_role(auth.uid(), 'admin'::app_role));
...
CREATE POLICY "Only admins can read base questions" ON public.quiz_questions FOR SELECT TO authenticated USING (has_role(auth.uid(), 'admin'::app_role));
